...
class DataPublisher:
    def __init__(self, pcd_dir, json_dir, jpg_dir, pointcloud_topic, odom_topic, img_topic):
...
if __name__ == '__main__':
    ...
    img_topic = '/iray/thermal_img4G'

    DataPublisher(pcd_dir, json_dir, jpg_dir, pcd_topic, odom_topic, img_topic)
